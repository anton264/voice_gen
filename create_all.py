...
for d in data:
    ...
    if previous_score > voice_threshold:
        print("✅ Skipping", d[0], "because it already has a score of", previous_score, ", which is above the threshold of ", voice_threshold)
        continue
    score = 0
